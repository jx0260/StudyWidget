...
public class MainActivity extends AppCompatActivity
    ...
    Button gestureBtn;
    @BindView(R.id.btn_textview_test)
    Button testTextViewBtn;
...
//            startActivityForResult(captureIntent, 1);
                ...
                startActivity(new Intent(MainActivity.this, TestAdjustPanActivity.class));
...
//                        .setAction("Action", null).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItemImpl item = (MenuItemImpl)menu.findItem(R.id.action_share);
...
//        mShareActionProvider = (ShareActionProvider) item.getSupportActionProvider();
    ...
    @OnClick(R.id.btn_gesture)
    void jump(){
        Intent in = new Intent(this, GestureActivity.class);
        startActivity(in);
    }

    @OnClick(R.id.btn_textview_test)
    void toTestTextView(){
        Intent in = new Intent(this, TextViewActivity.class);
        startActivity(in);
    }

    @OnClick(R.id.btn_main_imgTest)
    void toTestImageView(){
